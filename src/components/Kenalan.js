            ...
            <br/>
              <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <p className="par">
                    Program Juara SBMPTN Camp adalah program bimbingan belajar (bimbel) camp atau karantina intensif untuk persiapan SBMPTN dan Ujian Mandiri PTN. Program ini diselenggarakan oleh Sang Juara School yaitu bimbingan belajar IPA yang telah berpengalaman sejak tahun 2011.
                    </p>
                    <p className="par">
